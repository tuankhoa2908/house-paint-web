...
export default function Footer() {
	...
	return (
		<footer className="w-full border-t border-gray-200 bg-white dark:border-gray-800 dark:bg-black">
			<div className="mx-auto max-w-7xl px-6 py-4 lg:px-4">
				<div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
					...
					<div className="col-span-1 md:col-span-2 lg:col-span-2">
						...
						<p className="mt-4 max-w-md text-sm text-gray-600 dark:text-gray-400">
							Cung cấp các sản phẩm sơn chất lượng cao cho ngôi nhà của bạn. Với
							nhiều năm kinh nghiệm trong ngành, chúng tôi cam kết mang đến giải
					...
					<div>
						...
						<ul className="space-y-3">
							<li>
								<Link
									href="/products"
									className="text-sm text-gray-600 transition-colors hover:text-cyan-600 dark:text-cyan-400 dark:hover:text-white"
								>
									Sản phẩm
								</Link>
							</li>
				...
				{/* Bottom Bar */}
				<div className="border-t border-gray-200 pt-4 pb-0 dark:border-gray-800">
